  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        // Other Styles
        'Caption': ['0.75rem', { lineHeight: '1.25rem', fontWeight: '400', letterSpacing: '0.025em' }], // 12px
        'Overline': ['0.625rem', { lineHeight: '1.125rem', fontWeight: '400', letterSpacing: '0.094em' }], // 10px
      }
    },
  },
  plugins: [],
